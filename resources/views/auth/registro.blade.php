...
<form class="max-w-xl px-8 py-1 mx-auto bg-white rounded shadow dark:bg-slate-800"  action="{{route('auth.store')}}" method="POST">
	@csrf
<div class="space-y-4">
	<label class="flex flex-col">
		...
		@enderror
	    	...
	    	<a class="text-sm font-semibold underline border-2 border-transparent rounded dark:text-slate-300 text-slate-600 focus:border-slate-500 focus:outline-none" href="{{route('welcome')}}">Login</a>
