<x-layouts.app title="Empresas" meta-description="empresas">
    	<div class="flex flex-wrap">
    		<div class="w-full sm:w-4/5 md:w-4/5 lg:w-7/8 p-4 mb-1">
    			<form class="rounded" action="{{route('empresas.search')}}" method="POST">
    				@csrf
    				...
    				<div class="relative">
    					...
    					<input type="search" id="default-search" class="block w-full p-6 pl-10 text-bg text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Número de empresa" autofocus="autofocus" required type="text" name="id" id="id">
    					<button id="buscarempresa" type="submit" class="text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-8 py-4 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="submit">Buscar</button>
    				</div>
    			</form>
    		</div>
        <div class="w-full md:w-1/5 lg:w-1/5 xl:w-1/8 p-4 mb-1">
            ...
            href="{{route('empresas.nuevo')}}">Crear</a>
        </div>
    		<div class="w-full sm:w-4/5 md:w-4/5 lg:w-7/8 p-4 mb-1">
    			<table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
    				...
    				<tbody>
    					...
    					<tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                {{$elemento->celulartitular}}
                            </th>
    						<td class="px-6 py-4 text-right">
    							<a href="{{route('empresas.ver',$elemento->id)}}">Ver</a>
    						</td>
    					</tr>
    					@endforeach
    				</tbody>
