<x-layouts.app title="Servicios" meta-description="Servicios">
	<div class="flex flex-wrap">
		<div class="w-full sm:w-4/5 md:w-4/5 lg:w-7/8 p-4 mb-1">
			<form class="rounded" action="{{route('servicios.show')}}" method="POST">
				@csrf
				...
				<div class="relative">
					...
					<button id="buscarservicio" type="submit" class="text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-8 py-4 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="submit">Buscar</button>
				</div>
			</form>
		</div>
		<div class="w-full md:w-1/5 lg:w-1/5 xl:w-1/8 p-4 mb-1">
			...
			href="{{route('servicios.create')}}">Agregar nuevo</a>
		</div>
			...
			<tbody>
				...
				<tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
					...
					<td class="px-6 py-4 text-right">
						<a href="{{route('servicios.ver',$elemento->id)}}">Ver</a>
					</td>
				</tr>
				@endforeach
			</tbody>
