<x-layouts.appCreacion title="Datos de servicio" meta-description="Servicio informacion">
	<h1 class="my-4 font-serif text-3xl text-center text-sky-600 dark:text-sky-500">Datos de servicio</h1>
	<form class="max-w-xl px-8 py-4 mx-auto bg-white rounded shadow dark:bg-slate-800"  action="{{route('servicios.store')}}" method="POST">
		@csrf
		<div class="space-y-4">
