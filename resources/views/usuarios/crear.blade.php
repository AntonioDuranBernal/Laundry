<x-layouts.app title="Datos de registro" meta-description="Registro">
	...
	action="{{route('usuario.guardar')}}" method="POST">
	@csrf
...
<label class="flex flex-col">
	<span class="font-serif text-slate-800 dark:text-slate-400">Sucursal</span>
	<div class="flex flex-col">
		<select class="form-select appearance-none
		block
		w-full
		...
		ease-in-out
		m-0
		focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" aria-label="Sucursal" type="text" name="sucursal" autofocus="autofocus">
...
<div class="flex items-center justify-between mt-4">
	<a class="text-sm font-semibold underline border-2 border-transparent rounded dark:text-slate-300 text-slate-600 focus:border-slate-500 focus:outline-none" href="{{route('usuarios.inicioUsuarios')}}">Cancelar</a>
